...
if ($queueNumber === '' || !preg_match('/^[0-9]{2,6}$/', $queueNumber)) {
    http_response_code(400);
    die('Invalid queue number');
}

$queue = q_find_queue($queueNumber);
if (!$queue) {
...
<div class="wrap">
  ...
  <form method="post" action="/save_queue.php" onsubmit="selectAllAgents()">
    ...
    <div class="inner-box" style="margin-top:0;">
      <div class="top">
        <span class="pill">EDIT MODE</span>
      ...
      <div class="panel-box tab-pane" id="tab_codes">
        ...
        <div style="margin-top:14px;">
          ...
          <div class="note" style="margin-top:12px;">powered by rafik.</div>
        </div>
      </div>
